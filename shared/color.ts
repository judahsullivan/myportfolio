...
export const linkColors = {
    light: 'red.500',
    dark: 'messenger.500',
    lhover: 'blackAlpha.500',
    dhover: 'whiteAlpha.500',
    visitedLight: 'red.900',
    visitedDark:'messenger.900',
}
...
export function useLinkColorHover() {
    return useColorModeValue(linkColors.lhover, linkColors.dhover)
}
